          ...
          <div className="flex gap-2">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder={
                  activeTab === "surat" ? "Cari surat..." : "Cari pengaduan..."
                }
                className="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-1 focus:ring-primary-500"
                value={searchTerm}
            ...
            <div className="relative">
              <select
                className="pl-3 pr-8 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-1 focus:ring-primary-500 appearance-none"
                value={filterStatus}
